...
- Between rounds, spend your retainer on **of counsel** jokers — Stare Decisis rewards consistent precedent, DR-312 voids boss rules, Summary Admin triples small filings.
...
- Every third blind is a **Boss Audit**: The Disgruntled Heir debuffs a suit, Form 706 costs you a filing, and Missing Original Will excludes a card per hand.
- The preview strip runs the real scoring engine, counsel included, before you commit. Missing Original Will audits show the full possible score range.
...
- Survive Ante 8 and obtain the final order closing the estate.
